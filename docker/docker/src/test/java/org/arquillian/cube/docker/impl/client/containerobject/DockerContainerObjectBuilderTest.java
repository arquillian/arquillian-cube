...
public class DockerContainerObjectBuilderTest {
    ...
    private static void initDockerCubeMappedPort(DockerCube dockerCube, String containerIP, int exposedPort,
        int boundPort) {
        PrivilegedExceptionAction<Void> action = () -> {
            Field dockerCubePortBindingsField = DockerCube.class.getDeclaredField("portBindings");
            dockerCubePortBindingsField.setAccessible(true);
            ...
            Object dockerCubePortBindings = dockerCubePortBindingsField.get(dockerCube);
            Map<Integer, HasPortBindings.PortAddress> mappedPorts =
                (Map<Integer, HasPortBindings.PortAddress>) dockerCubePortBindingsMappedPortsField.get(
                    dockerCubePortBindings);
    ...
    public void shouldStartAContainerObjectDefinedUsingDockerfile() {
        ...
        try {
            TestContainerObjectDefinedUsingDockerfile containerObject =
                new DockerContainerObjectBuilder<TestContainerObjectDefinedUsingDockerfile>(dockerClientExecutor,
                    cubeController, cubeRegistry)
    ...
    public void shouldStartAContainerObjectDefinedUsingDescriptor() {
        final AtomicReference<DockerCube> cubeRef = new AtomicReference<>();
        try {
            TestContainerObjectDefinedUsingDescriptor containerObject =
                new DockerContainerObjectBuilder<TestContainerObjectDefinedUsingDescriptor>(
    ...
    public void shouldLinkInnerContainersWithLink() {
        final AtomicReference<DockerCube> cubeRef = new AtomicReference<>();
        try {
            TestContainerObjectWithAnnotatedLink containerObject =
                new DockerContainerObjectBuilder<TestContainerObjectWithAnnotatedLink>(
                    dockerClientExecutor, cubeController, cubeRegistry)
    ...
    public void shouldLinkInnerContainersWithoutLink() {
        final AtomicReference<DockerCube> cubeRef = new AtomicReference<>();
        try {
            TestContainerObjectWithNonAnnotatedLink containerObject =
                new DockerContainerObjectBuilder<TestContainerObjectWithNonAnnotatedLink>(dockerClientExecutor,
                    cubeController, cubeRegistry)
    ...
    public void shouldStartAContainerObjectDefinedUsingImage() {
        final AtomicReference<DockerCube> cubeRef = new AtomicReference<>();
        try {
            TestContainerObjectDefinedUsingImage containerObject =
                new DockerContainerObjectBuilder<TestContainerObjectDefinedUsingImage>(dockerClientExecutor,
                    cubeController, cubeRegistry)
    ...
    public void shouldStartAContainerObjectDefinedUsingImageAndEnvironmentVariables() {
        ...
        try {
            ...
            TestContainerObjectDefinedUsingImageAndEnvironmentVariables containerObject =
                new DockerContainerObjectBuilder<TestContainerObjectDefinedUsingImageAndEnvironmentVariables>(
                    dockerClientExecutor, cubeController, cubeRegistry)
    ...
    public void shouldStartAContainerObjectDefinedUsingImageAndVolumes() {
        ...
        try {
            ...
            CubeContainerObjectConfiguration ccoconfig = new CubeContainerObjectConfiguration(ccconfig);
            TestContainerObjectDefinedUsingImageAndVolumes containerObject =
                new DockerContainerObjectBuilder<TestContainerObjectDefinedUsingImageAndVolumes>(dockerClientExecutor,
                    cubeController, cubeRegistry)
        ...
        assertThat(cube.getMetadata(IsContainerObject.class).getTestClass(), is(nullValue()));
        assertThat(cube.configuration().getImage().toImageRef(), is(BASE_IMAGE));
        assertThat(cube.configuration().getBinds(),
            hasItems("/mypath:/containerPath:rw", "/mypath2:/containerPath2:rw", "/mypath3:/containerPath3:rw"));
    ...
    public void shouldEnrichAContainerWithCubeIp() {
        ...
        try {
            TestContainerObjectWithCubeIp containerObject =
                new DockerContainerObjectBuilder<TestContainerObjectWithCubeIp>(
                    dockerClientExecutor, cubeController, cubeRegistry)
    ...
    public void shouldEnrichAContainerWithHostPort() {
        ...
        try {
            TestContainerObjectWithHostPort containerObject =
                new DockerContainerObjectBuilder<TestContainerObjectWithHostPort>(
                    dockerClientExecutor, cubeController, cubeRegistry)
