...
public class ContainerNetworkObjectDslTestEnricherTest {
    ...
    public void should_start_a_network() {
        ...
        ContainerNetworkObjectDslTestEnricher containerNetworkObjectDslTestEnricher =
            new ContainerNetworkObjectDslTestEnricher();
        ...
        when(dockerClientExecutor.createNetwork(eq("default"),
            any(org.arquillian.cube.docker.impl.client.config.Network.class))).thenReturn("default");

        containerNetworkObjectDslTestEnricher.enrich(new NetworkTest());

        verify(dockerClientExecutor).createNetwork(eq("default"),
            any(org.arquillian.cube.docker.impl.client.config.Network.class));
