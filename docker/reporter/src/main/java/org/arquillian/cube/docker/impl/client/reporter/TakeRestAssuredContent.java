...
public class TakeRestAssuredContent {
    ...
    public void registerFilterForRecorder(@Observes(precedence = -10) RestAssuredConfiguration restAssuredConfiguration,
        ...
        RestAssured.filters(new TakeRequest(reportEvent, reporterConfiguration),
            new TakeResponse(reportEvent, reporterConfiguration));
    }
    ...
    public static class TakeResponse implements Filter {
        ...
        public Response filter(FilterableRequestSpecification requestSpec, FilterableResponseSpecification responseSpec,
            ...
            final File logFile = new File(createLogDirectory(new File(reporterConfiguration.getRootDirectory())),
                "restassuredResponse.log");
    ...
    public static class TakeRequest implements Filter {
        ...
        public Response filter(FilterableRequestSpecification requestSpec, FilterableResponseSpecification responseSpec,
            ...
            uri =
                urlDecode(uri, Charset.forName(requestSpec.getConfig().getEncoderConfig().defaultQueryParameterCharset()),
                    true);
