...
See how you can link:GETTING_STARTED.adoc[get started] with Arquillian Cube.

To read the complete documentation visit http://arquillian.org/arquillian-cube/

Finally, refer to the link:CONTRIBUTING.adoc[contribution guidelines] if you wish to contribute to Arquillian Cube.
endif::generated-doc[]
