...
WARNING: 1.0.0.Alpha13 changes default format from Cube to Docker Compose. In case you are using Cueb format you need to update arquillian.xml with `<property name="definitionFormat">CUBE</property>`
