...
public interface AutoStartOrder<T> {
     ...
     * @return List of cubes to start. Each element of the list is an array of identifiers. All elements of the array are started in parallel.
     */
     ...
     * @param config Configuration object.
     * @return List of cubes to stop. Each element of the list is an array of identifiers. All elements of the array are stopped in parallel.
     */
