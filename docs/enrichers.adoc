...
private URL url;
----
But to be able to do this, you need to set the Router host and configure it under arquillian.xml:
[source, xml]
.arquillian.xml
----
