...
| name                                | String         | Any | Username to log in server
| password                            | String         | Any | Password to log in server
| authToken                           | String         | Any | Bearer token for authentication to the API server
| apiVersion                          | String(v1)     | Any | Version for API server
| trustCerts                          | Boolean(true)  | Any | Boolean to trust Certificate
