...
| fmp.path  | String | Any | Path to pom.xml where fmp plugin configuration is present. Defaults to "pom.xml".
| fmp.build | Bool (false) | Any | Whether to generate resources using fmp when running test from IDE
|===
