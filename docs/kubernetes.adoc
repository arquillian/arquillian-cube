...
If it is not prefixed, then the resource is considered to be placed inside classpath and is resolved as is.

For example: `@IstioResource("istio_route_rule.yaml")`
