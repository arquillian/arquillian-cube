...
|cleanBuildImage
|Boolean to set if Cube should also remove the images on which container is build after removing the container. By default is true. Can be overwritten on container level.
